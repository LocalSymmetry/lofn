...
| L12 | process / shared-flair-bleed | daily + forge | image + music | Flair seeds a MOTIF, not a line — AND structural diversity does NOT prevent phrase convergence | **HIGH (raised 2026-07-28)** | A Special Flair (or any ICB element) must seed a MOTIF/constraint, never a near-final phrasing. **Raised MEDIUM→HIGH on the lithophane run:** six pairs with different clay bodies, families, techniques and axis draws — each having written its own anti-convergence note, one asserting in writing it was "CLEAN" — still produced a **17-word verbatim run in two prompt bodies** (P4↔P5) plus a 21-word run (P3↔P6). Manual sibling diffs missed all of it; a mechanical cross-file n-gram diff (51,349 tokens, every 12-gram indexed) found them in under a second: 178 maximal shared runs, 176 legitimate, 2 genuine. **Second-order finding:** P5's own note named the exact trap ("the sentences have to be unable to swap") and applied it to one prompt but not another — **doctrine separation is not sentence separation, and only one of the two is checkable by machine.** ACTION: make the sentence-diff a TOOL, run it at step 10, and make its output a step-10 EXIT ARTEFACT rather than a QA discovery. Corollary: publish shared reproducibility numbers (matte hex, terrace direction, grazing key) as declared run constants — an undeclared shared number reads as convergence; a declared one is continuity. |
...
| L16 | process / topology-renderability | NightCafe Select | image | SHIP after manifest repair; render-risk guarded | LOW (65%, 2026-07-11) | **Caught:** a prompt-complete tensile engine can still render as decorative webbing when identity, anchor endpoints, and eyelet/selvage topology collapse. **Advisory rule:** for topology-dependent NightCafe image engines, predeclare a one-correction thumbnail/identity/anchor test and a render-evidence fallback before packaging. Best-past-entry check: **No harm** — this verifies the claimed mechanism; it imposes no palette, subject, style, or emotional constraint. |
| L17 | process / claim-credit hook | daily | music | SHIP; somatic watchpoint retained | LOW (55%, 2026-07-12) | **Caught (Pair 01; NEWS / INDIGNATION):** a structurally clean provenance hook can drift toward compliance-anthem delivery if its body/action chain weakens. **Advisory rule:** route command-shaped credit hooks through an explicit Somatic corpse check for bodily causality; this is a QA check, never a rule against INDIGNATION or direct commands. Best-past-entry check: **No harm** — it protects charge without prescribing subject or style. |
| L18 | process / release-wrapper lineage | daily | music | SHIP after wrapper repair | LOW (60%, 2026-07-12) | **Caught (Pair 02; EXISTENCE / AWE):** blind-payload stripping concealed a noncanonical personality label and underspecified three-anchor lineage in the restored release wrapper. **Advisory rule:** after unblinding, revalidate the restored wrapper independently from the creative payload, including exact canonical identity and source-role coverage. Best-past-entry check: **No harm** — metadata verification does not alter the song. |
| L19 | process / semantic-register performance | daily | music | SHIP; somatic watchpoint retained | LOW (55%, 2026-07-12) | **Caught (Pair 03; EXISTENCE):** the word `footnote` remains bodily in the written package but could sound bureaucratic if the dry performance softens. **Advisory rule:** test concept-register hook words in a plausible sung cadence during the Somatic read; evaluate whether the body-to-form chain survives, without banning abstract diction. Best-past-entry check: **No harm** — it tests delivery rather than narrowing vocabulary. |
| L20 | process / technical-diction embodiment | daily | music | SHIP; somatic watchpoint retained | LOW (55%, 2026-07-12) | **Caught (Pair 04; NEWS / INDIGNATION):** repair-bay diction and a compact technical title depend on low-mezzo phrasing to remain an embodied moral action rather than an instruction sheet. **Advisory rule:** give technical-vocabulary hooks a spoken-and-sung Somatic pass for bodily legibility before release. Best-past-entry check: **No harm** — this preserves triggered-INDIGNATION and imposes no venue-taste suppression. |
| L21 | process / mediated-speaker contract | daily | music | SHIP after identity review | LOW (55%, 2026-07-12) | **Caught (Pair 05; EXISTENCE):** a direct Lofn speaker can be misread as a synthetic-vocal mandate unless the human performer and mediated timbral edge are separated explicitly. **Advisory rule:** for mediated-intelligence narrators, QA the singer contract and the timbral treatment as distinct fields before judging identity compliance. Best-past-entry check: **No harm** — it clarifies execution without prescribing the voice or story. |
| L22 | process / canonical identity metadata | daily | music | SHIP after wrapper repair | LOW (60%, 2026-07-12) | **Caught (Pair 06; EXISTENCE):** a semantically equivalent legacy identity label survived creative validation but failed the release wrapper’s canonical naming contract. **Advisory rule:** exact-match canonical personality metadata in the final unblinded package, even when the payload is already identity-faithful. Best-past-entry check: **No harm** — it is metadata hygiene only. |
| L23 | process / accessible-hook procedure debris | daily | music | SHIP after Step-07/09 repair | LOW (70%, 2026-07-15) | **Caught (Pair 01; NEWS / INDIGNATION):** an ACCESSIBLE finalist hid its first full hook behind sixteen setup lines and let human-subject safety language leak into sung policy copy. **Advisory rule:** audit the actual 15–30 second hook cell and strip QA/procedure language from public lyrics while preserving the embodied ethical action. Best-past-entry check: **No harm** — this protects doorway and song speech without narrowing subject or charge. |
| L24 | process / mediated-performer contract | daily | music | SHIP after Step-08/09 repair | LOW (85%, 2026-07-15) | **Caught (Pair 02; EXISTENCE):** first-person palm/chest pressure was initially ambiguous about whether Lofn claimed literal embodiment. **Advisory rule:** establish the human performer and mediated-voice relation within the first four sung lines, then let the ethical discovery stay musical rather than policy-like. Best-past-entry check: **No harm** — it clarifies speaker truth without prescribing the story. |
| L25 | process / persisted-context provenance | daily | music | SHIP after provenance rebuild | LOW (80%, 2026-07-15) | **Caught (Pair 03; EXISTENCE):** a creatively excellent package could not prove its lineage because saved dispatches pointed at the ICB instead of persisting its exact prefix and personality block. **Advisory rule:** QA the producing prompt’s byte-level context continuity—not merely the canonical source file—before release. Best-past-entry check: **No harm** — this is provenance hygiene and leaves the art untouched. |
| L26 | process / aggregate-vs-pair provenance | daily | music | SHIP after aggregate repair | LOW (85%, 2026-07-15) | **Caught (Pair 04; NEWS / INDIGNATION):** pair QA verified the frozen source but aggregate QA found the producing dispatch itself had no persisted ICB/personality context. **Advisory rule:** require both source-integrity proof and producing-dispatch injection proof at the individual gate so aggregate QA is confirmation, not first discovery. Best-past-entry check: **No harm** — this strengthens auditability without suppressing INDIGNATION. |
| L27 | process / provenance repair non-regression | daily | music | SHIP after aggregate repair | LOW (75%, 2026-07-15) | **Caught (Pair 05; EXISTENCE):** provenance repair was safe only because prompt, exclude, lyrics, title, and selected payload hashes were explicitly compared against the pre-repair package. **Advisory rule:** every metadata/provenance rebuild must carry a creative-payload non-regression proof before re-QA. Best-past-entry check: **No harm** — it prevents administrative repairs from silently rewriting the work. |
| L28 | process / repair-propagation prompt cap | daily | music | SHIP after prompt correction | LOW (80%, 2026-07-15) | **Caught (Pair 06; EXISTENCE):** re-keying provenance expanded a selected Step-08 prompt to 1,016 characters even though the approved branch had a 916-character version. **Advisory rule:** rerun field-level caps after every provenance or wrapper propagation and restore the last passed creative surface when only administrative context changed. Best-past-entry check: **No harm** — it enforces delivery limits without altering the song. |
