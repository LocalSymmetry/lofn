# Pair 06 Step 06 Facets - square lattice mercy
...
Facet: the hook "lock the door before the bloom" must recur in two choruses and return altered in the outro.
...
Facet: adult female mezzo Ab3-Db5, stern mix, dry vowel grain, close-mic precision; rhythm law is square-tile pulse in 4 cells, the fourth cell drops out.

## 4. Mythic Seed Pressure & EMO Dramaturgy

Facet: Awe, Relief, Unease must change across verse, bridge, and final chorus.

## 5. Production Dramaturgy & Lofn Afterimage

Facet: 0:11 prefusion gate cuts everything but breath and 36Hz hold is structural, not decorative.
...
```json
{"step":"06_pair_facets","pair_id":"06","pair_title":"square lattice mercy","no_fusion":true,"no_audio_rendering":true,"status":"pass_to_step_07"}
```
