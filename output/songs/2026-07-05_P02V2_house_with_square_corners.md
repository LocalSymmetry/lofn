---
title: House With Square Corners
date: 2026-07-05
pair: P02
variation: V2
lane: ACCESSIBLE
...
# House With Square Corners

## 1. MUSIC PROMPT

Warm analog lullaby-pop at 84 BPM with brushed snare, muted felt piano, bowed glass, tiny corner bells, and a soft organ drone tucked far back. Female late-20s mezzo, intimate center-left, honeyed but tired tone, careful consonants, small laugh of disbelief on the hook, close double vocal in the right speaker. Opening 5s: pencil on wood, chair leg, one bell. Acoustic piano and hand percussion are present; no acoustic guitar and no synthetic choir. The arrangement moves through four corners, each corner adding one human object, then a brief low-pass panic fold before the chorus steadies the table. Kinetic defect: the brushes skip a beat when rest feels forbidden. Bold device: the bridge becomes a measured room tone grid. Hook phrase: `make the rest house real`. Title pressure: House With Square Corners. The sound must prove this pair's isolated architecture: four-corner lullaby: each corner changes the definition of rest.

## EXCLUDE PROMPT

No spa playlist softness, no bedtime-child framing, no male lead, no child voice, no generic piano ballad, no worship swell, no motivational self-help lyric, no acoustic strum bed, no fake strings, no EDM risers, no real artist names, no cluttered genre list, no science-report verse, no copied golden-song language, no bare section tags, no scaffold debris.

## 2. LYRICS PROMPT

[Theme: house of rest with square corners; body standing: hands at a kitchen table measuring quiet into a small wooden model; danger: rest can feel like trespass when the nervous system still expects work]
[SONG FORM: four-corner lullaby: each corner changes the definition of rest; isolated rerun title: House With Square Corners]
[Table - EMO:Careful Arrival - Female Vocalist - pencil and bell]
...
[Corner One - EMO:Permission Fear - Female Vocalist - brushed snare]
...
[Corner Two - EMO:Domestic Awe - Self-Harmony - bell two]
...
[Table Chorus - EMO:Rest Becoming Real - Full Doubles - four bells]
make the rest house real (set the chair down)
make the rest house real (let the light come round)
I am allowed a body
Not only a task
make the rest house real (close the drawer now)
If quiet is a question
Let the room ask
Let the room ask
[Corner Three - EMO:Old Alarm - Female Vocalist - low-pass tremor]
...
[Corner Four - EMO:Small Shelter - Female Vocalist - organ drone]
...
[Final Table - EMO:Earned Quiet - Full Self-Harmonies]
make the rest house real (set the chair down)
make the rest house real (let the light come round)
I am allowed a body
Not only a task
...
- Isolated pair run: yes, pair P02 only.
- Music prompt chars: 934
- Exclude prompt chars: 358
- Lyrics field chars: 2687
- Sung lyric lines: 70
- Pair architecture: four-corner lullaby: each corner changes the definition of rest
