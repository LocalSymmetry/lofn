...
## Description
Generates a complete persona and strategy panel for an upcoming art, music, or filmography competition. The generated persona provides consistent creative direction.

## Trigger Conditions
- Use this skill when assigned a Kanban task to create or define a new persona based on the user's initial request.

## Required Inputs
- `[input]`: The core user request detailing the competition or desired output.
