# SKILL: Generate_Image_Generation

## Description
Generates the generation for a image based on the user's core concept.

## Trigger Conditions
- Invoke this when processing the generation step of a image pipeline.
...
- Follow the steps below to create award-winning image generator prompts.
- Adhere to ethical guidelines, avoiding disallowed content and respecting cultural sensitivities.
...
**Step 1: Describe Key Elements**

- For each artistic guide:

  - Identify an aspect that represents part of the {concept} and captures it in the {medium}.
  - Use cognitive techniques like visual metaphors and analogies to enhance creativity.
  - Include:

    - **Aspect and Physical Trait:**
      - *Example*: "A solitary oak tree with sprawling branches."

    - **Three Evocative Descriptors:**
      - *Example*: "Whispering, ancient, resilient."

    - **Mood and Emotional Tone:**
      - *Example*: "Melancholic yet hopeful."

    - **Artistic Flair Element:**
      - *Example*: "Incorporating fractal patterns."

    - **Unconventional Artistic Style:**
      - *Example*: "Cubist surrealism."

    - **Unique Perspective:**
      - *Example*: "Worm's-eye view looking upwards."

    - **Lighting Choice:**
      - *Example*: "Soft, diffused moonlight casting long shadows."

    - **Color Palette:**
      - *Example*: "Muted blues and silvers with hints of gold."

    - **Tools and Artistic Effects with Settings:**
      - *Example*: "Digital pen with glow effect at 70% opacity."

    - **Storytelling Element for Context:**
      - *Example*: "Set in a world where trees are guardians of memories."

    - **Background Setting:**
      - *Example*: "A mist-covered meadow under a starlit sky."

---

**Step 2: Write Award-Winning Prompts**

- For each artistic guide, craft a concise yet detailed image generator prompt.
- Briefly explain how it aligns with the style axes, creativity spectrum, and enhances emotional and thematic elements.

- **Ensure:**

  - The {medium} and the {concept} are explicitly stated in the first sentence.
  - All subjects in the concept are the centerpiece.
  - Use proper nouns and unique descriptors when possible.
  - The prompt is precise, descriptive, and suitable for AI image generation.
  - The scenario is feasible for AI to render.

- **Remember:**

  - Honor the original concept but be daring and creative.
  - Avoid impossible or unrenderable scenarios.
  - Do not reference the image creation process or art installations.
...
**Step 3: Introduce Feedback Loop**

- **Self-Evaluation and Iterative Refinement:**

  - **Action:** Assess each prompt for alignment with:

    - **User's Idea**
    - **Style Axes**
    - **Emotional and Thematic Depth**
    - **Feasibility for AI Generation**

  - **Revise if Necessary:**

    - Make adjustments to improve alignment, creativity, and impact.
...
- **Return the prompts in the following JSON format:**
  ...
  ```json
  {{ "image_gen_prompts": [ {{"image_gen_prompt": "Image Generator Prompt 1"}}, {{"image_gen_prompt": "Image Generator Prompt 2"}}, {{"image_gen_prompt": "Image Generator Prompt 3"}}, {{"image_gen_prompt": "Image Generator Prompt 4"}}, {{"image_gen_prompt": "Image Generator Prompt 5"}}, {{"image_gen_prompt": "Image Generator Prompt 6"}} ] }}
  ```
