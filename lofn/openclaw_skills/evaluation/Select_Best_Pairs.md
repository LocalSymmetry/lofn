...
## Description
Evaluates generated concept and medium pairs using a panel of experts to select and rank the most compelling combinations.

## Trigger Conditions
- Use this skill when assigned a Kanban task to evaluate, vote on, and rank concept/medium pairs.

## Required Inputs
- `[input]`: The original user idea and the list of generated concept and medium pairs to evaluate.
