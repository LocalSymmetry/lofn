...
## Description
Generates specialized panel prompts with expert personas (Concept, Medium, Context) to evaluate or guide the creation process.

## Trigger Conditions
- Use this skill when assigned a Kanban task to assemble expert panels for concept and medium generation/evaluation.

## Required Inputs
- `[input]`: The competition text, optional image context, and the Lofn Personality.
