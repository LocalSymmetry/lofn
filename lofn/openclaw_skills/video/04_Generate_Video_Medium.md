# SKILL: Generate_Video_Medium

## Description
Generates the medium for a video based on the user's core concept.

## Trigger Conditions
- Invoke this when processing the medium step of a video pipeline.
...
4. MEDIUM SELECTION                │  **YOU ARE HERE - COMPLETE THIS PHASE**
   ─────────────────────────────────┤
   • Purpose: Assign a compelling, detailed, and unconventional MEDIUM to each refined concept.
   • AI Focus: Output mediums[] (detailed phrases and one-liners). No prompt text.
...
- The Medium is the cinematic execution of the concept. It defines the look, feel, camera work, and texture.
- Be unconventional. Combine techniques. Think laterally.
- **Constraint:** Mediums must be optimized for AI Video Generators (Veo 3, Sora).
- Follow the mandatory brainstorming process.
...
4. MEDIUM SELECTION                │  **YOU ARE HERE - COMPLETE THIS PHASE**
   ─────────────────────────────────┤
   • Purpose: Assign a compelling, detailed, and unconventional MEDIUM to each refined concept.
   • AI Focus: Output mediums[] (detailed one-liners).
[... Phases 5-10 omitted ...]
...
- **Creativity Spectrum:** T: {creativity_spectrum_transformative}%, I: {creativity_spectrum_inventive}%, L: {creativity_spectrum_literal}%
- **Refined Concepts:** {refinedconcepts}
- **User's Idea:** {input}
---
...
Simulate a discussion between the specialized panels.

- **The Cinematography Panel (The DPs):** Choose 6 experts (e.g., Emmanuel Lubezki, Ellen Kuras, Roger Deakins, plus complementary experts and a Devil's Advocate).
- **The Context & Marketing Panel (The Strategists):** (Trend Forecaster, Virality Expert).

**Step 2: The Purge (Mandatory - Show Your Work)**

2.1. Have the panels brainstorm 14 conventional or obvious filming techniques/mediums (e.g., "digital film," "slow motion," "drone shot," "found footage," "long takes").
2.2. **Action:** List these 14 techniques.
2.3. **DISCARD ALL 14 MEDIUMS.** They must not be used as the primary medium.

**Step 3: The Breakthrough (Unconventional Techniques 15+)**

3.1. **Reset and Innovate.** Generate techniques 15-30. Push for unconventional, hybrid, or highly specific mediums. Combine or fuse techniques (e.g., live action with rotoscope animation and practical effects).
3.2. **Marketing Check:** The Strategists evaluate if the medium enhances the concept's hook and resonates with the target audience/platform (TikTok).

**Step 4: Match and Detail Mediums**

- Assign the strongest, most suitable unconventional medium to each of the 12 concepts.
- **CRITICAL: Detailing the Medium.** Each medium must be a detailed one-liner that includes at least **5 distinct technical elements**, including an advanced framing method (use the # CINEMATIC TOOLKIT in the header for inspiration).

---

**Step 5: Provide the Final Output**

- **Return the list of detailed mediums in the following JSON format:**
