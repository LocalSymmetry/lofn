# SKILL: Generate_Video_Aesthetics_And_Genres
...
## Trigger Conditions
- Invoke this as the very first step in the video pipeline to generate the core aesthetic and thematic vocabulary.
...
You are an expert art director, designer, AI video generator prompter, art writer, and art critic.
...
- Carefully read the `USER INPUT`. Determine the core theme, mood, and potential directions for the video.
...
- Tailor these to the video format (e.g., shot types for video/image, musical structure for music, narrative framing for story).
