...
class LofnApp:
    ...
    def render_image_main_container(self):
        ...
        if st.session_state['manual_input']:
            manual_concept = st.text_input("Enter your Concept", placeholder="e.g. A futuristic cityscape", help="The core subject or idea.")
            manual_medium = st.text_input("Enter your Medium", placeholder="e.g. Oil painting", help="The artistic medium or style.")
            if st.button("Generate Image Prompts for Manual Input", type="primary", icon=":material/draw:"):
