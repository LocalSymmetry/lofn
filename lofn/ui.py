...
class LofnApp:
    ...
    def render_image_main_container(self):
        ...
        if st.session_state['manual_input']:
            ...
            if st.button(
                ...
                help="Generate prompts based on your manually entered concept and medium.",
            ):
        ...
        if st.button(
            ...
            help="Generate initial artistic concepts from your description.",
        ):
        ...
        if st.session_state.get('competition_mode') and st.button(
            ...
            help="Run a panel competition to select the best concepts.",
        ):
            if not st.session_state['input'].strip():
                st.warning("Please provide a description of your idea.")
            else:
    ...
    def display_concepts(self):
        ...
        # Buttons to proceed
        if st.button(
            "Generate Image Prompts for Selected Concepts",
            type="primary",
            icon=":material/check_circle:",
            help="Generate detailed prompts for the selected concepts only.",
        ):
            if selected_pairs:
        ...
        if st.button(
            "Generate Image Prompts for All Concepts",
            icon=":material/grid_view:",
            help="Generate detailed prompts for all generated concepts.",
        ):
    ...
    def render_video_generation(self):
        ...
        if st.button(
            ...
            type="primary",
            icon=":material/movie:",
            help="Generate video concepts from your description.",
        ):
            if not st.session_state['input'].strip():
                st.warning("Please provide a description of your idea.")
            else:
    ...
    def display_video_concepts(self):
        ...
        if st.button(
            "Generate Video Prompts for Selected Concepts",
            type="primary",
            icon=":material/check_circle:",
            help="Generate detailed prompts for the selected concepts only.",
        ):
        ...
        if st.button(
            "Generate Video Prompts for All Concepts",
            icon=":material/grid_view:",
            help="Generate detailed prompts for all generated concepts.",
        ):
    ...
    def display_music_concepts(self):
        ...
        if st.button(
            "Generate Music Prompts for Selected Concepts",
            type="primary",
            icon=":material/check_circle:",
            help="Generate detailed prompts for the selected concepts only.",
        ):
        ...
        if st.button(
            "Generate Music Prompts for All Concepts",
            icon=":material/grid_view:",
            help="Generate detailed prompts for all generated concepts.",
        ):
    ...
    def render_music_generation(self):
        ...
        if st.button(
            ...
            help="Generate music concepts and prompts from your description.",
        ):
            if not st.session_state['input'].strip():
