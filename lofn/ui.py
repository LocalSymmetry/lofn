...
class LofnApp:
    ...
    def render_image_main_container(self):
        ...
        if st.session_state['manual_input']:
            ...
            if st.button("Generate Image Prompts for Manual Input", type="primary", icon=":material/edit:"):
    ...
    def display_concepts(self):
        ...
        if st.button("Generate Image Prompts for All Concepts", type="primary", icon=":material/collections:"):
    ...
    def display_video_concepts(self):
        ...
        if st.button("Generate Video Prompts for All Concepts", type="primary", icon=":material/video_library:"):
    ...
    def display_music_concepts(self):
        ...
        if st.button("Generate Music Prompts for All Concepts", type="primary", icon=":material/library_music:"):
