...
class LofnApp:
    ...
    def render_image_main_container(self):
        ...
        if st.session_state['manual_input']:
            ...
            if st.button("Generate Image Prompts for Manual Input", icon=":material/edit_square:"):
    ...
    def display_concepts(self):
        ...
        # Buttons to proceed
        if st.button("Generate Image Prompts for Selected Concepts", type="primary", icon=":material/image:"):
            if selected_pairs:
        ...
        if st.button("Generate Image Prompts for All Concepts", icon=":material/photo_library:"):
    ...
    def display_video_concepts(self):
        ...
        if st.button("Generate Video Prompts for Selected Concepts", type="primary", icon=":material/videocam:"):
            if selected_pairs:
                for idx in selected_pairs:
        ...
        if st.button("Generate Video Prompts for All Concepts", icon=":material/video_library:"):
    ...
    def display_music_concepts(self):
        ...
        if st.button("Generate Music Prompts for Selected Concepts", type="primary", icon=":material/library_music:"):
            if selected_pairs:
                for idx in selected_pairs:
        ...
        if st.button("Generate Music Prompts for All Concepts", icon=":material/queue_music:"):
