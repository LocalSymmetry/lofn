...
class LofnApp:
    ...
    def render_image_main_container(self):
        ...
        st.text_area(
            label="Art Idea",
            label_visibility="hidden",  # hides it visually but keeps it accessible
        ...
        if st.session_state.get('competition_mode') and st.button("Run Competition", key="run_competition", icon=":material/trophy:"):
            if not st.session_state['input'].strip():
                st.warning("Please provide a description of your idea.")
            else:
    ...
    def render_video_generation(self):
        ...
        if st.session_state.get('competition_mode') and st.button("Run Competition", key="run_video_competition", icon=":material/trophy:"):
            if not st.session_state['input'].strip():
                st.warning("Please provide a description of your idea.")
            else:
    ...
    def display_video_concepts(self):
        ...
        if st.button("Generate Video Prompts for Selected Concepts", type="primary", icon=":material/movie:"):
            if selected_pairs:
                for idx in selected_pairs:
    ...
    def render_music_generation(self):
        ...
        if st.session_state.get('competition_mode') and st.button("Run Competition", key="run_music_competition", icon=":material/trophy:"):
            if not st.session_state['input'].strip():
                st.warning("Please provide a description of your song idea.")
            else:
