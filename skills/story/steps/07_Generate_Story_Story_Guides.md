...
7. WRITING PIECE GUIDE CREATION         │  **YOU ARE HERE - COMPLETE THIS PHASE**
   ─────────────────────────────────┤
   • Purpose: Expand each facet into a focused writing guide (Storytelling Techniques, Mood & emotional arc, Prose Style, Structure & pacing, Character Depth, Narrative & thematic suggestions).  Six guides total.
   • AI Focus: Write 6 compact guide documents. **35-50 lines each, max.** Story beats need room to breathe but stay focused. No prompt wording. Stop here.
   • ⚠️ LENGTH CHECK: If a guide exceeds ~50 lines, you're overwriting. Compress.
