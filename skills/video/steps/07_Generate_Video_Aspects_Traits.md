...
7. SHOT GUIDE CREATION             │  **YOU ARE HERE - COMPLETE THIS PHASE**
   ─────────────────────────────────┤
   • Purpose: Expand each facet into a focused shot guide (scene, camera,
     lighting, movement, timing, transitions).  Six guides total.
   • AI Focus: Write 6 compact guide documents. **25-40 lines each, max.** Shot guides need scene + camera + timing but stay focused. No prompt wording.
   • ⚠️ LENGTH CHECK: If a guide exceeds ~40 lines, you're overwriting. Compress.

8. RAW VIDEO PROMPT GENERATION     │
   ─────────────────────────────────┤
