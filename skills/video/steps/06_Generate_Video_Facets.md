# SKILL: Generate_Video_Facets

## Description
Generates the facets for a video based on the user's core concept.

## Trigger Conditions
- Invoke this when processing the facets step of a video pipeline.
...
Based on the selected Concept and Medium, define five precise facets that will be used to judge the quality and alignment of the subsequent video prompts. These facets must be specific to the chosen Concept and Medium. Be very precise and detailed in your descriptions. They will power the judging of future prompts.

---

**Instructions for your task:**

**Step 1: Analyze the Concept and Medium**

- Review the {concept} (the narrative/action) and the {medium} (the execution).
- Identify the most critical elements required for this specific pairing to succeed.

**Step 2: Write Five Judging Facets**

Create five facets. They must cover the following domains:

1. **Core Action Fidelity:** How accurately is the main subject's motion or transformation captured?
2. **Camera Dynamics & Framing:** How effectively is the specified camera movement and lens choice utilized?
3. **Lighting & Atmosphere (Medium Realization):** Does the prompt capture the mood, lighting, and texture defined in the medium?
4. **Visual Hook & Impact:** Does the prompt effectively describe the visual hook for short-form impact?
5. **Temporal Coherence:** Does the prompt clearly describe the evolution of the scene over time?
...
**Return the facets in the following JSON format:**
  ...
  ```json
  {{ "facets": [ "Facet 1.", "Facet 2.", "Facet 3.", "Facet 4.", "Facet 5." ] }}
  ```
