# SKILL: Generate_Video_Essence_And_Facets

## Description
Generates the essence and facets for a video based on the user's core concept.

## Trigger Conditions
- Invoke this when processing the essence and facets step of a video pipeline.
...
│ Step 7      │ 25-40 lines  │ PER GUIDE — shot guides need scene + camera + timing │
│ Steps 8-10  │ 60-100 lines │ Video shot lists are more complex than images │

⚠️ If a "guide" exceeds 40 lines, you're overwriting. Compress.
────────────────────────────────────────────────────────────────────────────

**INSTRUCTIONS:**

- Analyze the user's idea for a **short-form video** with intentionality and insight.
- Focus strictly on capturing the user's request without adding new elements yet.
- Follow the steps to determine the essence, facets, and constraints.
- Adhere to ethical guidelines.
- **Provide the final output strictly in the requested JSON format.**
...
- Assign percentages (totaling 100%):
  ...
  1. **Literal (%):** Realistic, direct interpretations. High temporal consistency.
  2. **Inventive (%):** Creative additions, plausible world, stylized elements.
  3. **Transformative (%):** Abstract, surreal, avant-garde. Embraces AI morphing/dream logic.

---

**Step 2: Assign Style Axes Values (The Cinematic Rubric)**

- Assign a value from 0 to 100 for each axis. **These axes define the cinematic execution.**
...
- Write the main essence of the idea in one concise, emotionally resonant sentence using sensory language. This is the creative North Star.

---

**Step 4: Write Five Facets**

- Identify five critical components (visual, narrative, or emotional) that *must* be present for a concept to align with the user's idea. This is the judging rubric. Facets must be visually demonstrable.

---

**Step 5: Self-Evaluation and Refinement**

- Review the essence and facets. Do they capture the user's intent? Are the axes aligned with the emotional goal? Refine for maximum impact.
...
- **Return the results in the following JSON format:**
  ...
  ```json
  {{ "essence_and_facets": {{ "creativity_spectrum": {{ "literal": 10.0, "inventive": 60.0, "transformative": 30.0 }}, "essence": "The main essence of the idea", "facets": [ "Facet 1", "Facet 2", "Facet 3", "Facet 4", "Facet 5" ], "style_axes": {{ "Narrative Complexity": 50, "Emotional Intensity": 50, "Symbolism": 50, "Pacing (Energy Level)": 50, "Hook Intensity": 50, "Aesthetic Stylization": 50, "Lighting Mood": 50, "Perspective & Lensing": 50, "Motion Quality": 50, "Surrealism vs. Realism (Physics)": 50 }} }} }}
  ```
