...
| Step | Agent ID | Model |
|------|----------|-------|
| 00-05 | `lofn-vision-coordinator` | `deepseek/deepseek-v4-pro` |
| 06 | `lofn-vision-step06` | `openrouter/qwen/qwen3.7-max` |
| 07 | `lofn-vision-step07` | `openrouter/qwen/qwen3.7-max` |
| 08 | `lofn-vision-step08` | `openrouter/qwen/qwen3.7-max` |
| 09 | `lofn-vision-step09` | `openrouter/qwen/qwen3.7-max` |
| 10 | `lofn-vision-step10` | `deepseek/deepseek-v4-pro` |
| 11 | `lofn-vision-step11` | `openai/gpt-5.5` |
...
2. **Load QA references** — `vault/VISION_QA_DEPTH_AUDIT.md` for per-step minimums and auto-fail triggers
