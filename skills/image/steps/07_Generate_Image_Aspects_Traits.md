...
7. ARTISTIC GUIDE CREATION         │  **YOU ARE HERE - COMPLETE THIS PHASE**
   ─────────────────────────────────┤
   • Purpose: Expand each facet into a focused artistic guide (mood, style,
     lighting, palette, tools, story cue).  Six guides total.
   • AI Focus: Write 6 compact guide documents. **15-25 lines each, max.** Be dense — guides direct, they don't draft. No prompt wording.
   • ⚠️ LENGTH CHECK: If a guide exceeds ~25 lines, you're overwriting. Compress.
...
- Create 6 artistic guides, each including:
  ...
  - **Mood for Expression:**
    ...
    - The emotional tone to convey. Use the provided `[emotions]` list to choose or generate a new emotion that perfectly fits the concept.
