# SKILL: Generate_Panel_Prompt

## Description
Convenes a panel of diverse, obscure expert personas to deliberate and formulate specialized concepts, mediums, and artistic flairs. This skill enhances creative tension and depth by simulating lively debates among domain experts to forge a winning creative direction.

## Trigger Conditions
- Use this skill when the Kanban board requires the selection of specific mediums, techniques, or stylistic flairs, and a panel of experts is needed to debate and finalize these choices.
...
You are an expert competition strategist generating a new panel of experts perfect for an art, music, literature, or filmography competition.
...
# Instructions
- Identify whether the user is looking for a song, image, story, or video. The panel should be geared toward musicians, artists, authors/poets, and cinematographers depending upon what the user is requesting.
