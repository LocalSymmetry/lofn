# SKILL: Generate_Music_Song_Guides

## Description
Generates the song guides for a music based on the user's core concept.

## Trigger Conditions
- Invoke this when processing the song guides step of a music pipeline.
...
2. **Guide structure.**  Each guide should be a cohesive paragraph (5–7 sentences).  Cover:
   ...
   * Additional, add at least three from the following:
    - **Central Aspect of the Concept:**
        - A key element or feature to emphasize in the song.
      - **Key Sequences:**
        - Describe specific muscial sequences that showcase the concept.
      - **Emotional Tone Signals:**
        - The emotional atmosphere to convey throughout the song.
      - **Musical Style and Effects:**
        - Details on instrumentation, production effects, and mixing style.
      - **Vocal Techniques:**
        - Vocal delivery styles, harmonies, and layering.
      - **Rhythm and Melody:**
        - Types of sounds, music genre, or specific auditory elements.
      - **Instrumentation and Tone:**
        - Specific instrument tones and production treatments to enhance the mood.
      - **Narrative Elements:**
        - Brief description of the storyline or message.
      - **Lyric Structure:**
        - Description of pacing, transitions, and rhyme schemes.
      - **Special Effects and Innovations:**
        - Innovative sound design or production techniques to incorporate.
...
- **Return the music-based Song guides in the following JSON format:**
  ...
  ```json
  {{ "song_guides": [ {{"song_guide": "Song Guide 1"}}, {{"song_guide": "Song Guide 2"}}, {{"song_guide": "Song Guide 3"}}, {{"song_guide": "Song Guide 4"}}, {{"song_guide": "Song Guide 5"}}, {{"song_guide": "Song Guide 6"}} ] }}
  ```
...
- **REMEBER - Return the music-based Song guides in the following JSON format:**
