...
4a2. **Golden Song References (MANDATORY for Orchestrator + Step 11/manual Step 11):** Orchestrator reads `references/golden_songs_index.md`, selects exactly two public Golden Songs, and passes them through `06_audio_handoff.md`. Step 11 and manual Step 11 must include those two references as calibration examples of Lofn's proven public style. Learn proportion, hook logic, and identity pressure; do not copy titles, hooks, melodies, lyrics, or signature devices.
