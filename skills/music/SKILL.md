...
5. Follow the full coordinator/pair-agent split architecture exactly as specified in `references/music_full_legacy.md`.
6. Preserve all artifact names, step order, Suno prompt requirements, lyric requirements, and subagent split rules from the legacy text.
7. Do not call music generation tools; this skill writes Suno-ready text artifacts only.
