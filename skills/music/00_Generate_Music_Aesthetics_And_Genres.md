# SKILL: Generate_Music_Aesthetics_And_Genres
...
## Trigger Conditions
- Invoke this as the very first step in the music pipeline to generate the core aesthetic and thematic vocabulary.
...
- Carefully read the `USER INPUT`. Determine the core theme, mood, and potential directions for the music.
...
- Tailor these to the music format (e.g., shot types for video/image, musical structure for music, narrative framing for story).
