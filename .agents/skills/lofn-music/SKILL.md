...
- **Verse diversity:** the 6 songs use 6 DIFFERENT verse architectures + rhyme schemes + poetic techniques (assigned per pair in Phase 1). Uniformity is a repair. In dailies, same section sequence or same lyric-sentence skeleton across pairs is not "cohesion"; it is pair bleed and must rerun from Step 05.
